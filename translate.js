...
const i18Obj = {
    ...
    'zh': {
        ...
        // Main page
        'your-food-court': '您的家庭美食广场',
        'delivery': '配送',
        'order-in': '点餐',
        'takeout': '外带',
        'grab-and-go': '自取',
        'delivery-time': '巴黎全境30分钟内送达',
        'free-delivery': '满29欧元免运费',
        'fresh-products': '只用新鲜法国食材',
        'restaurants': '餐厅',
        'show-all': '显示全部',
        'nearest-restaurants': '离您最近的餐厅',
        'delivery-area': '每个厨房有自己的配送区域，确保尽快送达',
        'enter-address': '输入配送地址',
        'send': '发送',
        'specialties': '特色菜',
        'statistics-kitchen': '厨房',
        'statistics-specialties': '特色',
        'statistics-restaurants': '餐厅',
        'statistics-transport': '运输费用',
        'instagram': '在Instagram',
        'bagel': '百吉饼',
        'burger': '汉堡',
        'chicken': '鸡肉',
        'fish': '鱼',
        ...
        'franchise': '加盟',
        'business': '商务',
        'restaurant-signup': '餐厅注册',
        'for-investors': '投资者',
        'get-help': '帮助',
        'read-faqs': '常见问题',
        'restaurants': '餐厅',
        'specialties': '特色菜',
        'signup-deliver': '成为配送员',
        'contact-us': '联系我们',
        'privacy-policy': '隐私政策',
        'terms': '条款',
        'copyright': '© 2020 Yellow kitchen',
        // Catalog translations
        'catalog-title': 'Yellow Kitchen - 菜单',
        ...
        'rating-max': '最高评分',
        'array-map': 'Map: 首字母大写',
        'array-filter': 'Filter: 价格 < €20',
        'array-reduce': 'Reduce: 总价',
        'array-sort': 'Sort: 价格降序',
        'array-slice': 'Slice: 前5个',
        'array-find': 'Find: 评分5',
        'array-some': 'Some: 价格 < €10',
        'array-every': 'Every: 评分 > 3',
        'array-forEach': 'ForEach: 名称日志',
        'array-concat': 'Concat: 添加示例菜品',
        // Dynamic content translations
        'add-to-cart': '加入购物车',
        ...
        'first': '首页',
        'last': '末页',
        'cart-title': 'Yellow Kitchen - 购物车',
        'checkout': '结账',
        'favorites-title': 'Yellow Kitchen - 收藏',
        'feedback-title': 'Yellow Kitchen - 反馈',
        'leave-feedback': '留下反馈',
        'select-dish-label': '选择菜品',
        'select-dish-placeholder': '选择菜品',
        'rating-label': '评分',
        'comment-label': '评论',
        'comment-placeholder': '请输入您的反馈（至少10个字符）',
        'send-feedback': '发送反馈',
        'admin-title': 'Yellow Kitchen - 管理面板',
        'admin-dishes-tab': '菜品管理',
        'admin-feedback-tab': '反馈管理',
        'admin-add-dish': '添加新菜品',
        'admin-dish-name': '名称 <span class="text-red-500">*</span>',
        'admin-dish-description': '描述 <span class="text-red-500">*</span>',
        'admin-dish-price': '价格 <span class="text-red-500">*</span>',
        'admin-dish-category': '类别 <span class="text-red-500">*</span>',
        'admin-dish-category-placeholder': '选择类别',
        'admin-dish-image': '图片 <span class="text-red-500">*</span>',
        'admin-add-dish-btn': '添加菜品',
        'admin-dishes-list': '菜品列表',
        'admin-feedback-title': '反馈管理',
        'admin-user-filter': '用户筛选',
        'admin-user-filter-placeholder': '所有用户',
        'about-title': '关于我们 - Yellow Kitchen',
        'about-story-title': '我们的故事',
        'about-story-text': 'Yellow Kitchen于2010年作为一家小型家庭面包店起步。自那时以来，我们已成长为本市最著名的糕点店之一，同时保持着家庭烘焙的温暖与舒适。',
        'about-values-title': '我们的价值观',
        'about-values-text': '我们相信品质、传统和创新。我们的每一款产品都用心制作，只选用最优质的原料和经过时间考验的配方。',
        'about-future-title': '我们的未来',
        'about-future-text': '我们不断发展，用新口味和新创意让顾客满意。我们的目标是成为本市最好的糕点店，同时保持家庭烘焙的灵魂和品质。',
        'home': '首页',
        'catalog': '菜单',
        'feedback': '反馈',
        'gallery': '画廊'
    ...
    if (langSwitcher) {
        ...
        langSwitcher.innerHTML = `
            <div class="flex items-center gap-2">
                <span class="text-[#d4d7e5]">${currentLang === 'en' ? 'English' : currentLang === 'ru' ? 'Русский' : 'Chinese'}</span>
            ...
            <div class="language-dropdown hidden absolute top-full left-0 bg-white shadow-lg rounded-md mt-1">
                ...
                <button onclick="setLang('zh')" class="block w-full text-left px-4 py-2 hover:bg-gray-100">Chinese</button>
            </div>
        `;
